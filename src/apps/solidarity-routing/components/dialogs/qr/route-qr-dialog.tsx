...
import QRCode from "~/apps/solidarity-routing/components/dialogs/qr/route-qr-code";
...
export const RouteQRDialog: FC<TProps> = ({ data }) => {
  ...
  const emailPayload = useMemo(() => {
    return {
      email: emailAddress,
      message: `Here is your route for today: ${env.NEXT_APP_URL}/tools/routing/${fileID}`,
