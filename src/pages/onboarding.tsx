  ...
  return (
    <>
      ...
      <Tabs
        ...
        className="ignore-default h-svh fixed grid w-full overflow-hidden  bg-slate-100/50 lg:grid-cols-[280px_1fr]"
      >
            ...
            <div className="mt-auto p-4">
              <Card>
                <CardHeader className="pb-4">
                  <CardTitle>Don&apos;t have time?</CardTitle>
                  <CardDescription>
                    You can always complete the setup later in your account.
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <Link href="/">
        ...
        <main className="h-svh flex flex-col overflow-y-auto">
          <div className="sticky top-0 z-20 flex hidden items-center gap-4 bg-white p-4">
            <Container
              className={cn(
                "hidden py-6",
      ...
      {/* <OnboardingLayout>
        ...
        >
          ...
          <div className="flex max-h-[100svh]  w-full max-w-7xl flex-col items-center justify-center">
            <div className=" mx-auto  flex w-full flex-col place-content-center justify-center space-y-8  p-8 align-middle">
              {/* <div className={cn(currentStep === "get-started" && "hidden")}>
                <h1 className="text-3xl font-bold">
                  {currentStep === "get-started" &&
                    "      Welcome to Artisanal Futures!"}
                  {currentStep === "shop" && "Setting up your shop"}
